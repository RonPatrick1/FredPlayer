...
final class RemoteLibraryClient {
    ...
    static JSONArray fetchLibrary(String baseUrl, String token) throws IOException, JSONException {
        String body = get(requireSecureBaseUrl(baseUrl) + "/api/library", token);
    ...
    static JSONArray fetchPlaylistTracks(String baseUrl, String token, String name) throws IOException, JSONException {
        String body = get(requireSecureBaseUrl(baseUrl) + "/api/playlists/" + Uri.encode(name), token);
    ...
    static void sharePlaylist(String baseUrl, String token, String name, JSONArray tracks)
        ...
        post(
                requireSecureBaseUrl(baseUrl) + "/api/playlists",
                token,
    ...
    static JSONObject askLiam(String baseUrl, String token, String deviceId, String message)
        ...
        String body = post(
                requireSecureBaseUrl(baseUrl) + "/api/ask-liam",
                token,
                requestBody.toString(),
    ...
    private static String requireSecureBaseUrl(String baseUrl) throws IOException {
        return ServerUrlPolicy.normalizeAndValidate(baseUrl, BuildConfig.DEBUG);
    }
